...
def parse_args(args):
    ...
    parser.add_argument("--version_tokenizer", default="YxZhang/evf-sam2")
...
def init_models(sam_version_tokenizer, sam_version, device="cuda"):
...
def sam_infer(image_size, image_np, prompt, tokenizer, model):
    # clarify IO
...
def main(args):
    ...
    tokenizer, model = init_models(args, args.sam_version_tokenizer, args.sam_version, device='cuda')

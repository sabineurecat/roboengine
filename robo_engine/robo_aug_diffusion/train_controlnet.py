...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--pretrained_model_name_or_path",
        type=str,
        default="/cephfs/shared/yuanchengbo/roboaug/diffusion_ckpt/stabilityai/stable-diffusion-2-inpainting",
        required=False,
    ...
    parser.add_argument(
        ...
        type=str,
        default="/cephfs/shared/yuanchengbo/roboaug/diffusion_ckpt/controlnet",
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/cephfs/shared/yuanchengbo/roboaug/diffusion_ckpt/controlnet-model-mix-data",
    ...
    parser.add_argument(
        "--train_data_dir",
        type=str,
        default="/root/project/robo_engine/robo_seg_dataset/mask_data_hf",
        help=(
...
def make_original_dataset(args, tokenizer, accelerator):
    # Get the datasets: you can either provide your own training and evaluation files (see below)
    # or specify a Dataset from the hub (the dataset will be downloaded automatically from the datasets Hub).
...
def collate_fn(examples):
    ...
    for example in examples:
        ...
        random_index = torch.randint(0, input_ids_.size(0), (1,)).item()
        input_ids_list.append(input_ids_[random_index])
...
def main(args):
    ...
    original_dataset = make_original_dataset(args, tokenizer, accelerator)
    ...
    controlnet, optimizer, train_dataloader, original_dataloader, lr_scheduler = accelerator.prepare(
        controlnet, optimizer, train_dataloader, original_dataloader, lr_scheduler
    )
